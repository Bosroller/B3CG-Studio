...
export default function TopBar({ onMenuClick, userEmail, onLogout }: TopBarProps) {
  return (
    <div className="sticky top-0 z-30 bg-gradient-to-r from-slate-800 to-slate-900 border-b border-slate-700 px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        ...
        <div className="min-w-0">
          <h2 className="text-base sm:text-lg font-semibold text-white truncate">Bosroller Studio</h2>
